...
array_list *gjson_get_array(json_object *parent, const char *key)
{
	json_object *o = NULL;
	...
	return json_object_get_array(o);
}
...
/*****************************************************************************************************
@function:      int gjson_string_to_json(char *string, unsigned long len, json_object **json)
...
@return:        none
******************************************************************************************************/
int gjson_string_to_json(char *string, unsigned long len, json_object **json)
{
...
/* unused */
/*int gjson_string_to_json(char *data, json_object **obj)
{
	*obj = json_tokener_parse(data);
