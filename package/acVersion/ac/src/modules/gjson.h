...
extern array_list *gjson_get_array(json_object *parent, const char *key);

extern int gjson_contain_key(json_object *parent, char *key);
extern int gjson_parameter_exist(json_object *input, char **parameters, int param_num);
...
extern int gjson_string_to_json(char *string, unsigned long len, json_object **json);
